...
@Component({
  selector: 'app-habitation-details',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './habitation-details.component.html',
})
export class HabitationDetailsComponent implements OnInit, OnDestroy {
  @Input() formValue: any;
  ...
  getCompanyName(companyId: number): string {
    if (!companyId || !this.insuranceCompanies) return 'N/A';
